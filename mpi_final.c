...
void distributedCanny(unsigned char* colorImage, unsigned char* finalImage, const int width, const int height, int comm_sz, int my_rank);
void distributedGrayscale(unsigned char* colorImage, unsigned char* grayImage, const int width, const int height, int comm_sz, int my_rank);
void distributedGaussianBlur(unsigned char* grayImage, unsigned char* blurredImage, const int width, const int height, int comm_sz, int my_rank);
void distributedEdgeDetection(unsigned char* blurredImage, unsigned char* edgeImage, float* directions, const int width, const int height, int comm_sz, int my_rank);
void distributedNonMaxSuppression(unsigned char* edgeImage, unsigned char* suppressedImage, float* directions, int width, int height, int comm_sz, int my_rank);
void distributedThreshold(unsigned char* suppressedImage, unsigned char* thresholdImage, int width, int height, int comm_sz, int my_rank);
void distributedCleanup(unsigned char* thresholdImage, unsigned char* finalImage, int width, int height, int comm_sz, int my_rank);
...
void distributedCanny(unsigned char* originalImage, unsigned char* finalImage, const int width, const int height, const int threadcount) {
  ...
  distributedGrayscale(originalImage, grayscaleImage, width, height, height, height);
